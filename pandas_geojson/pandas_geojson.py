...
def write_geojson(geo_json, filename, indent=None, encoding='utf8'):
...
def read_geojson(filename, encoding='utf8'):
    with open(f'{filename}',encoding=encoding) as response:
